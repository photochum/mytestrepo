...
#define LED_GPIO  5 //2
#define LED_GPIO_MUX  PERIPHS_IO_MUX_GPIO5_U //PERIPHS_IO_MUX_GPIO2_U
#define LED_GPIO_FUNC  FUNC_GPIO5//FUNC_GPIO2
...
LOCAL void ICACHE_FLASH_ATTR blink_cb(void *arg)
{
	...
	led_state ^=1;
	//os_printf("Inside blink\n");	//use this to print out to COM4
}
